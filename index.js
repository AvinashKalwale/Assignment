...
app.post('/math', function(req, res){
    ...
    if(req.body.submit === "add"){
        ...
        if(result > 1000000){
            ...
            res.send({status:"success",message:"the sum of given two numbers is",sum:result});
        }
        ...
        if(result < -1000000){
            ...
            res.send({status:"success",message:"the difference of given two numbers is",difference:result});
        }
    }
        ...
        if(result < -1000000){
            ...
            res.send({status:"success",message:"the product of given two numbers is",result:result});
        }
    }
    else{
        let result=Number(num1) / Number(num2)
        ...
        if(result === Infinity){
            ...
            res.send({status:"success",message:"the division of given two numbers is",result:result});
        }
    }
